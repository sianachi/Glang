...
class Pass2Checker:
    ...
    def _check_builtin_call(self, expr: CallExpr) -> Optional[TypeNode]:
        ...
        fixed = {
            ...
            "termRawOn": ([], NamedType("int")),
            "termRawOff": ([], NamedType("int")),
            "termWidth": ([], NamedType("int")),
            "termHeight": ([], NamedType("int")),
            ...
            "getEnv": ([NamedType("string")], NamedType("string")),
            "removeFile": ([NamedType("string")], NamedType("bool")),
            "makeDir": ([NamedType("string")], NamedType("bool")),
            "renameFile": ([NamedType("string"), NamedType("string")], NamedType("bool")),
            "isDir": ([NamedType("string")], NamedType("bool")),
